...
app.get('/', (req, res) => {
  mongoRepository.getProds(req.user).then((foundProds) => {
    res.render('index', { products: foundProds, categorias: listaCategorias })
  })
});
...
app.get('/prod/new', (req, res) => {
  console.log(req.user)
    res.render('prod/new', { loggedUser: req.user, categorias: listaCategorias })
})
